...
# 1. 加载原始 checkpoint
path = "/home/yd/ece489/project/rsl_rl_teacher_student/legged_gym/logs/rough_go2_challenging/ece489/model_9000.pt"
...
# 4. 保存为 .pth
torch.save(prop_dict, "proprio_oracle_ece489.pth")
print("✅ 已保存 proprio_oracle.pth")

torch.save(actor_dict, "actor_oracle_ece489.pth")
